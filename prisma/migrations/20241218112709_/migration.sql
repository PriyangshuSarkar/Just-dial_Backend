...
-- CreateEnum
CREATE TYPE "TestimonialType" AS ENUM ('REVIEW', 'FEEDBACK');
...
-- CreateTable
CREATE TABLE "_BusinessDetailsToCategory" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_BusinessDetailsToCategory_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_BusinessDetailsToCategory_B_index" ON "_BusinessDetailsToCategory"("B");
...
-- AddForeignKey
ALTER TABLE "_BusinessDetailsToCategory" ADD CONSTRAINT "_BusinessDetailsToCategory_A_fkey" FOREIGN KEY ("A") REFERENCES "BusinessDetails"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_BusinessDetailsToCategory" ADD CONSTRAINT "_BusinessDetailsToCategory_B_fkey" FOREIGN KEY ("B") REFERENCES "Category"("id") ON DELETE CASCADE ON UPDATE CASCADE;
